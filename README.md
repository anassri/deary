...
## Technologies Used
Deary is a full-stack application built with a React frontend and a Python/Flask backend. Most of the logic happens in the React frontend. The styling is mostly done with raw CSS, with a tiny help from the [Material UI framework](https://material-ui.com/).
...
### Conclusion
Deary is my second solo project and the first one with a Flask backend. I've had a lot fun building it and I've learned a lot during the process. 
