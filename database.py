...
with app.app_context():
  ...
  relationship1 = Relationship(user_id=7,friend_id=2, status=2, friends_since=random_date())
  relationship2 = Relationship(user_id=2,friend_id=7, status=2, friends_since=random_date())
  relationship3 = Relationship(user_id=7,friend_id=5, status=2, friends_since=random_date())
  relationship4 = Relationship(user_id=5,friend_id=7, status=2, friends_since=random_date())
  relationship5 = Relationship(user_id=7,friend_id=6, status=2, friends_since=random_date())
  relationship6 = Relationship(user_id=6,friend_id=7, status=2, friends_since=random_date())
  relationship7 = Relationship(user_id=7,friend_id=3, status=2, friends_since=random_date())
  relationship8 = Relationship(user_id=3,friend_id=7, status=2, friends_since=random_date())
  relationship9 = Relationship(user_id=4,friend_id=7, status=1, friends_since=random_date())
