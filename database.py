...
with app.app_context():
  ...
  relationship2 = Relationship(user_id=7, friend_id=5, action_user_id=7, status=2, friends_since=random_date())
  relationship3 = Relationship(user_id=7, friend_id=6, action_user_id=7, status=2, friends_since=random_date())
  relationship4 = Relationship(user_id=7, friend_id=3, action_user_id=7, status=2, friends_since=random_date())
